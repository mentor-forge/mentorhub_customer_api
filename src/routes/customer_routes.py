...
def create_customer_routes():
    ...
    def get_customers():
        ...
        logger.info(f"get_customers Success {str(breadcrumb['at_time'])}, {breadcrumb['correlation_id']}")
    ...
    def get_customer(customer_id):
        ...
        logger.info(f"get_customer Success {str(breadcrumb['at_time'])}, {breadcrumb['correlation_id']}")
