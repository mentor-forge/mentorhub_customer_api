...
app.register_blueprint(create_subscription_routes(), url_prefix='/api/subscription')
app.register_blueprint(create_dashboard_routes(), url_prefix='/api/dashboard')
app.register_blueprint(create_card_routes(), url_prefix='/api/card')
...
logger.info("  /api/subscription - Subscription domain endpoints")
logger.info("  /api/dashboard - Dashboard domain endpoints")
logger.info("  /api/card - Card domain endpoints")
...
if __name__ == "__main__":
    api_port = config.CUSTOMER_API_PORT
