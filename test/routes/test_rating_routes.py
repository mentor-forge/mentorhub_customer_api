...
class TestRatingRoutes(unittest.TestCase):
    ...
    def test_get_rating_not_found(
        ...
        mock_get_rating.side_effect = HTTPNotFound("Rating 999 not found")
    ...
    @patch("src.routes.rating_routes.create_flask_token")
    def test_get_ratings_unauthorized(self, mock_create_token):
        """Test GET /api/rating when token is invalid."""
