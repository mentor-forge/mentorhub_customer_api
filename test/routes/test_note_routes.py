"""
Unit tests for Note routes (consume-style, read-only).
"""
...
class TestNoteRoutes(unittest.TestCase):
    ...
    def test_get_notes_success(
        ...
        """Test GET /api/note for successful response."""
    ...
    def test_get_note_not_found(
        ...
        mock_get_note.side_effect = HTTPNotFound("Note 999 not found")
    ...
    @patch("src.routes.note_routes.create_flask_token")
    def test_get_notes_unauthorized(self, mock_create_token):
        """Test GET /api/note when token is invalid."""
