"""
Unit tests for Journey routes (consume-style, read-only).
"""
import unittest
...
class TestJourneyRoutes(unittest.TestCase):
    ...
    def test_get_journeys_success(
        self,
        mock_get_journeys,
        mock_create_breadcrumb,
        mock_create_token,
    ):
        """Test GET /api/journey for successful response."""
    ...
    @patch("src.routes.journey_routes.create_flask_token")
    def test_get_journeys_unauthorized(self, mock_create_token):
        """Test GET /api/journey when token is invalid."""
